...
<head>  
  ...
  <title><?= $data['judul']; ?></title>  
   <link rel="icon" href="assets/img/logotoko.png" type="image/x-icon">
  <!-- Bootstrap CSS -->
...
<body>  
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="sidebar" aria-labelledby="sidebarLabel">  
    <div class="offcanvas-header">  
      <img src="assets/img/logotoko.png" alt="Lunerburg & Co" class="img-fluid" style="height: 40px;">  
    ...
    <div class="px-3 py-2">  
      ...
      <form id="login-form">  
        ...
        <div class="mb-3">  
          ...
          <a href="registrasi.html" style="font-size:14px; display:block; margin-top:8px;">Belum punya akun? Daftar di sini</a>
        </div>  
    ...
    <!-- Navigation Links -->
    <div class="px-3">  
      <a href="index.html" class="d
Login-flex align-items-center mb-3">
